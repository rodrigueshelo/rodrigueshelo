...
**Excel e Google Sheets** - para limpezas e análises de dados, com a criação de tabelas dinâmicas e visualizações rápidas.

**SQL** - construção de consultas, filtragens e análise de dados.

**Python** - limpeza, análise e visualização de dados, utlizando bibliotecas Numpy, Pandas, Matplotlib.
...
• Comunicação clara e apresentação de resultados;  
• Raciocínio crítico e tomada de decisão baseada em dados;  
• Colaboração com diferentes áreas e stakeholders;  
• Organização, proatividade e autonomia;  
• Aprendizado contínuo e curiosidade investigativa.

Você pode entrar em contato comigo em:
<a href="https://www.linkedin.com/in/rodrigues-heloisa/"> Linkedin</a> | <a href="mailto:heloor@gmail.com"> Email </a>
